...
const Content = () => {
  ...
  return (
    <main className="bg-background">
      {/* Hero Section */}
      <section
        className="relative bg-cover bg-center h-[500px] sm:h-[600px] lg:h-[700px] flex flex-col items-center justify-center text-foreground px-6"
        style={{ backgroundImage: "url('/assets/banner_nenthom.jpg')" }}
      >
        <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-black/30 to-black/50"></div>
        <div className="relative z-10 text-center max-w-4xl">
          <h1 className="font-sans text-4xl sm:text-5xl lg:text-7xl font-light mb-6 leading-tight text-balance text-white">
            Nến Thơm Handmade
          </h1>
          <p className="text-base sm:text-lg lg:text-xl mb-10 text-white/90 font-light leading-relaxed max-w-2xl mx-auto text-pretty">
            Mang lại không gian thư giãn và ấm áp cho ngôi nhà của bạn
          </p>
          <button className="group px-8 py-4 border border-white text-white rounded-full backdrop-blur-sm hover:bg-white hover:text-black transition-all duration-300 hover:scale-105 font-medium">
            Khám Phá Ngay
                    ...
                    <SwiperSlide key={idx}>
                      ...
                      >
                        ...
                        <div className="relative overflow-hidden aspect-[3/4]">
                          ...
                          <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700 bg-white/10 backdrop-blur-[1px]"></div>
                        </div>

                        {/* Tên danh mục */}
                        <div className="p-6 bg-white/70 backdrop-blur-sm rounded-b-3xl">
