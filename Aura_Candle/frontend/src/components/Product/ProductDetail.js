                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 bg-white/80 backdrop-blur-md p-8 rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.05)] border border-emerald-100">
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="flex items-center gap-3">
                            <span className="text-emerald-600 text-3xl font-bold">{product.price?.toLocaleString("vi-VN")}đ</span>
                            {product.oldPrice && (
                                <span className="text-gray-400 line-through text-lg">{product.oldPrice.toLocaleString("vi-VN")}đ</span>
                            )}
                        </div>
                        ...
                        <div className="flex gap-4">
                            <button onClick={handleAddToCart} className="flex-1 bg-emerald-600 hover:bg-emerald-700 text-white py-3 rounded-xl font-medium shadow-md hover:shadow-lg transition-all duration-300">
                                🛒 Thêm vào giỏ
                            </button>
                            <button onClick={handleBuyNow} className="flex-1 bg-amber-400 hover:bg-amber-500 text-white py-3 rounded-xl font-medium shadow-md hover:shadow-lg transition-all duration-300">
                                Mua ngay
                            </button>
                        </div>
                ...
                <div className="bg-white/80 backdrop-blur-md mt-10 p-8 rounded-3xl shadow-[0_10px_30px_rgba(0,0,0,0.05)] border border-emerald-100">
                    ...
                    <form onSubmit={handleSubmitComment} className="mb-6">
                        ...
                        <textarea
                            ...
                            rows="3"
                        ></textarea>
                        <button type="submit" className="mt-3 bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-2 rounded-xl font-medium shadow-md transition">
                            Gửi đánh giá
                        </button>
                    </form>
                                ...
                                {replyTo === cmt._id && (
                                    <div className="ml-6 mt-3">
                                        <textarea
                                            ...
                                            rows="2"
                                        ></textarea>
                                        <button onClick={() => handleReplySubmit(cmt._id)} className="mt-2 bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-1 rounded-lg text-sm">
                                            Gửi phản hồi
                                        </button>
                                    </div>
                                )}
